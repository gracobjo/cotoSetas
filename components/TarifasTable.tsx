...
export function TarifasTable() {
  ...
  const filas =
    filtro === "todos"
      ? TARIFAS
      : TARIFAS.filter((t) => t.tipo === filtro);
      ...
      <div className="container-narrow">
        ...
        >
          ...
          <p className="mt-3 text-muted-foreground">
            Parque Micológico Montes del Noroeste Zamorano (PMZA-50.001). Elige
            tu modalidad y obtén un permiso digital con QR y firma
            anti-falsificación.
          </p>
        </motion.div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Límite de recolección</TableHead>
        ...
        {/* Mobile cards (interacción de compra) */}
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t.modalidad}</p>
                </div>
        ...
        <p className="mt-4 text-xs text-muted-foreground">
          Nota: Para la tarifa local se exige estar empadronado al menos 6 meses
          antes del inicio de la campaña general de otoño.
        </p>
      </div>
    </section>
  );
